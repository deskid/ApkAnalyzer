...
public class ApkAnalyzerCli {
    ...
    public static void main(String[] args) {
        ...
        instance.run(args);
//        ApkAnalyzerImpl apkAnalyzer = new ApkAnalyzerImpl(System.out, ApkAnalyzerCli.getAaptInvokerFromSdk("/Users/didi/Library/Android/sdk"));
//        apkAnalyzer.resNames(new File("/Users/didi/git/android-arscblamer/a.apk").toPath(), "string", "default", null);
//        apkAnalyzer.resValue(new File("/Users/didi/git/android-arscblamer/a.apk").toPath(), "string", "default", "A", null);
    }
    ...
    private static final class HelpFormatter extends BuiltinHelpFormatter {
         ...
         * desiredColumnSeparatorWidth how many characters wide to make the separation
